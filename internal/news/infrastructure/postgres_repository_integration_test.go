...
func TestPostgresNewsRepository_ResurrectOnSlugReuse(t *testing.T) {
	...
	n1, _ := domain.NewNews("Resurrect Test", "integration-test-resurrect-news-xyz", "", nil, nil, false, nil, nil, 0)
	...
	n2, _ := domain.NewNews("Resurrect Test Again", "integration-test-resurrect-news-xyz", "", nil, nil, false, nil, nil, 0)
