...
func TestPostgresProjectRepository_CRUD(t *testing.T) {
	...
	p, err := domain.NewProject(
		...
		nil, nil, false, true, nil, nil, 999, categoryID, nil,
	)
	if err != nil {
...
func TestPostgresProjectRepository_ResurrectOnSlugReuse(t *testing.T) {
	...
	p1, _ := domain.NewProject("Resurrect Test", "integration-test-resurrect-xyz", nil, nil, false, true, nil, nil, 0, categoryID, nil)
	...
	p2, _ := domain.NewProject("Resurrect Test Again", "integration-test-resurrect-xyz", nil, nil, false, true, nil, nil, 0, categoryID, nil)
...
func TestPostgresProjectRepository_CreateRollsBackOnBadRelation(t *testing.T) {
	...
	p, _ := domain.NewProject("Rollback Test", "integration-test-rollback-xyz", nil, nil, false, true, nil, nil, 0, categoryID, nil)
